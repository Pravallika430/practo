...
public class DoctorsPage {
    ...
    By doctors = By.xpath("//button[contains(.,\"No Booking Fee\")]");
    ...
    public String select_doctor() throws Exception
    {
        ...
        String selected_doctor_name = doctor_names.get(num).getText(); 
        System.out.println(selected_doctor_name);
    ...
    public static String get_selected_date()
    {
    	...
    	System.out.println(selected_date_value);
